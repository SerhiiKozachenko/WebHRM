...
namespace Hrm.Data.EF.Providers
{
    public class CustomRoleProvider : RoleProvider
    {
        ...
        {
            return this.usersRepo.FindOne(new UserInRoleSpecify(username, roleName)) != null;
        }
        ...
        {
            var user = this.usersRepo.FindOne(new UserByLoginSpecify(username));

            if (user != null)
            {
                return user.Role.ToString().Split(',');
            }
